...
void firesequence(){
      Serial.println("Firing Sequence Engaged");  
...
void movetohome(){
        Serial.println("Pitch Axis Moving to Low Position");
        ...
        delay(500);
        Serial.println("Pitch Axis Raising to Target Position");
      ...
      Serial.println("Searching for Rotation Axis Home"); 
      Serial.println("STARTING SWEEP 1");  
       digitalWrite(ROT_DIR_PIN,HIGH);
       for(int c=0;c<400;c++){
           int ROT_HOME_PIN_val= digitalRead(ROT_HOME_PIN);
           if (ROT_HOME_PIN_val == HIGH) {
              Serial.println("ROT SWITCH TRIGGERED. CUTOUT!! ");
              break; 
           }
       ...
       delay(500);
       Serial.println("STARTING SWEEP 2"); 
       ...
       for(int c=0;c<800;c++){
        ...
        delay(500);
        Serial.println("Final Positioning"); 
        digitalWrite(ROT_DIR_PIN    , HIGH);
        for(int c=0;c<65;c++){
            digitalWrite(ROT_STEP_PIN   , HIGH);
            delayMicroseconds(10000);
       ...
       Serial.println("ROT HOME SEARCH SEQUENCE COMPLETE"); 

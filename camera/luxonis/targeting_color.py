...
def parse_args():
    ...
    parser.add_argument("-create_trackbars", default=None, action='store_true', help="Creates trackbars for color adjustment.")
    parser.add_argument("-imshow_debug", default=None, action='store_true', help="Displays camera windows for viewing and displays print statements for debugging.")
...
###########################################################################
            ...
            # Do stuff here with targeting, simple PID reference - bad_guy_center or whatever
            
            # Then send commands to arduino over wire or USB 
